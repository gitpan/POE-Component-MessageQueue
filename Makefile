...
#     ABSTRACT => q[A Perl message queue based on POE that uses STOMP as its communication protocol.]
#     AUTHOR => q[David Snopek]
#     DIR => []
#     DISTNAME => q[POE-Component-MessageQueue]
#     EXE_FILES => [q[bin/mq.pl]]
...
FULLEXT = POE/Component/MessageQueue
BASEEXT = MessageQueue
...
PM_TO_BLIB = lib/POE/Component/MessageQueue/Storage/Memory.pm \
...
DISTVNAME = POE-Component-MessageQueue-0.1.0
...
pure_all :: $(INST_SCRIPT)/mq.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) $(INST_SCRIPT)/mq.pl

$(INST_SCRIPT)/mq.pl: bin/mq.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)/.exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/mq.pl
	$(CP) bin/mq.pl $(INST_SCRIPT)/mq.pl
	$(FIXIN) $(INST_SCRIPT)/mq.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/mq.pl
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/POE/Component/MessageQueue/Subscription.pm blib/lib/POE/Component/MessageQueue/Storage/Complex.pm blib/lib/POE/Component/MessageQueue/Queue.pm
	$(RM_F) blib/lib/POE/Component/MessageQueue/Storage/Memory.pm $(MAKEFILE_OLD) blib/lib/POE/Component/MessageQueue/Message.pm blib/lib/POE/Component/MessageQueue/Logger.pm
	$(RM_F) blib/lib/POE/Component/MessageQueue/Storage.pm blib/lib/POE/Component/MessageQueue/Client.pm blib/lib/POE/Component/MessageQueue/Storage/DBI.pm blib/lib/POE/Component/Server/Stomp.pm
	$(RM_F) blib/lib/POE/Component/MessageQueue/Storage/FileSystem.pm blib/lib/POE/Component/MessageQueue.pm $(FIRST_MAKEFILE)
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Net-Stomp" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
