...
TEST_FILE = test.pl
TEST_FILES = t/01_load.t t/02_client.t t/03_queue.t t/04_message.t
TESTDB_SW = -d
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Best" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Event-Notify" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
